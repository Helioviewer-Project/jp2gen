...
PRO HV_LASCO_PREP2JP2,ds,de,c2 = c2, c3 = c3,details_file = details_file, copy2outgoing = copy2outgoing
  ...
  if keyword_set(c2) then begin
     HV_LASCO_C2_PREP2JP2,ds,de,details_file = details_file, copy2outgoing = copy2outgoing,called_by = progname
  endif

  if keyword_set(c3) then begin
     HV_LASCO_C3_PREP2JP2,ds,de,details_file = details_file, copy2outgoing = copy2outgoing,called_by = progname
  endif
