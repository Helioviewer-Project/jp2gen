...
;
;restore,'~/hv/hvs/lasco_c2_prep2jp2_v2_Fri_May__1_17.37.35_2009.sav'
LASCO_LISTER,list
...
;
   if (file_exist(listname)) then begin
      ...
      prepped = JI_LAS_WRITE_HVS(storage.hvs_location,filename,storage.hvs_location,/c2,write = write,/standard_process)
