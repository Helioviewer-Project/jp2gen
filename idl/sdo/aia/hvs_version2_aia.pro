...
;
  b = {details:a,$  ; REQUIRED
       ...
       hvs_details_filename:'hvs_version2.pro',$ ; REQUIRED
       hvs_details_filename_version:'2.0'} ; REQUIRED
;
; Scaling algorithm
;
; get the image: A
...
;
  ...
  b.details[0].dataMin = 3.0
  b.details[0].dataMax = 50.0
...
;
  ...
  b.details[1].dataMin = 10.0
  b.details[1].dataMax = 1400.0
...
;
  ...
  b.details[3].dataMin = 60.0
  b.details[3].dataMax = 11000.0
...
;
  ...
  b.details[4].dataMin = 60.0
  b.details[4].dataMax = 13000.0
...
;
  ...
  b.details[6].dataMin = 8.0
  b.details[6].dataMax = 1500.0
