...
FUNCTION JI_HV_MDI_GET_LIST,mdidir,search_term,ds,de
;
...
; required. 
;
; JI_HV_MDI_PREP2JP2,'~/hv/dat/mdi/2003/','2003/10/01','2003/10/15',/int,mag
;
;

PRO JI_HV_MDI_PREP2JP2,mdidir,ds,de,int = int, mag = mag
...
;
     t0 = systime(1)  
     a = JI_HV_MDI_GET_LIST(mdidir,search_term, ds,de)
...
; JP2 log files
;
     filename = prefix + JI_HV_LOG_FILENAME_CONVENTION(nickname,date_start,date_end)
;
