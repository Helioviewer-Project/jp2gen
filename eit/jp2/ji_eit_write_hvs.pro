...
; 
;
function JI_EIT_WRITE_hvs,eit_start,eit_end,rootdir,write = write
;
;
;
...
outfile = eit_img_timerange_081111(dir_im=rootdir,start=eit_start,end=eit_end,write = write,/hvs)
