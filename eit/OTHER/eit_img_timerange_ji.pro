...
;-
FUNCTION  ji_eit_img_timerange,dir_im=dir_im,start_date=start_date,end_date=end_date,help=help,cosmic=cosmic,gif=gif,jpg=jpg,quality_jpg=quality_jpg,no_block_fill=no_block_fill,progressive=progressive,sav = sav,hvs = hvs
...
;; IF KEYWORD_SET(gif) eq 0 and KEYWORD_SET(jpg) eq 0 THEN BEGIN
;;    gif=1
...
outfile_storage = strarr(max_n_eit_files_perday*ndays)
outfile_storage(*) = '-1'
outfile_count = -1
...
;
; this is where the individual file is read in - the header is called 'h'
;
...
;                   write_gif,dir_im+datetime_string+'_eit'+this_wave+'_1024.gif',b0
            ...
            sss = size(b0)
            window,/free,xsize=sss[1],ysize=sss[2],/pixmap
            erase
            tvscl,b0
            xyouts,0.01,0.01,datetime_string,/norm,charsize=2,charthick=1.4,color=255
            write_gif,dir_im + datetime_string+'_eit'+this_wave+'_1024.gif',tvrd(),red,green,blue
            wdelete
            set_plot,'z'
         ...
         IF KEYWORD_SET(jpg) THEN BEGIN
            ...
            im[*,*,1]=g(b0)                          
            im[*,*,2]=b(b0)                                                                           
            WRITE_JPEG,dir_im+datetime_string+'_eit'+this_wave+'_1024.jpg', im,true=3,quality=100
         ENDIF
...
;
            ...
            header = add_tag(header,header.solar_r,'hv_rsun')
...
;
            ...
            hvs = {img:image_new, red:red, green:green, blue:blue, $
                   header:header,$
...
;;                    erase
;;                    tvscl,b0
;;                    WRITE_JPEG,dir_im+datetime_string+'_eit'+this_wave+'_1024.jpg', tvrd(),quality=100
;;                    wdelete
;;                    set_plot,'z'
;;                 ENDIF
